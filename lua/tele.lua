...
vim.keymap.set("n", "<leader>sg", builtin.live_grep, { desc = "[S]ind by rip[G]rep" })
vim.keymap.set("n", "<leader>sh", builtin.help_tags, { desc = "[S]ind [H]elp" })
vim.keymap.set("n", "<leader>sd", builtin.diagnostics, { desc = "[S]ind [D]iagnostics" })
